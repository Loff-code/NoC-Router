...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/swaggo/code/lab1/test_run_dir/Hello_should_just_print_the_LED_value/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/swaggo/code/lab1/test_run_dir/Hello_should_just_print_the_LED_value/Hello.vcd)";
